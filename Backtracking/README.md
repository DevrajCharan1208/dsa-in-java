...
This directory contains algorithmic implementations using the Backtracking strategy in Java.

## 📝 Topics Covered

| No. | Problem | Description | Solution Link |
|---|---|---|---|
| 1 | **Backtracking on Arrays** | Basic example of making changes to an array during recursive calls and undoing them while backtracking. | [`BT01BacktrackingOnArrays.java`](BT01BacktrackingOnArrays.java) |
| 2 | **String Subsets** | Finding all subsets (powerset) of a given string using backtracking — O(2ⁿ * n). | [`BT02StringSubsets.java`](BT02StringSubsets.java) |
