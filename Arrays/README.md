...
This directory contains solutions and implementations related to the Array data structure.
...
| 2 | **Largest in Array** | Finding the maximum element in a given array. | [`A02LargestInArray.java`](A02LargestInArray.java) |
| 3 | **Binary Search** | Searching a sorted array using the divide and conquer approach. | [`A03BinarySearch.java`](A03BinarySearch.java) |
